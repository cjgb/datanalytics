...
La lista de los distintos indicadores de formato puede consultarse en la [página de ayuda de strptime](https://stat.ethz.ch/R-manual/R-devel/library/base/html/strptime.html).
