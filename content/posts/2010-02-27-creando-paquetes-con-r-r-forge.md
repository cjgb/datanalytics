...
Hace poco no asistí a una conferencia del profesor [Campo Elías Pardo](https://scholar.google.com/citations?user=n0azHbIAAAAJ&hl=es) en la Universidad Nacional de Colombia sobre la creación de paquetes de R. Me pesó no poder asistir porque sospeché primero y corroboré después que se había obviado en ella una herramienta muy útil para la creación de paquetes con R: la [_forja oficial_](http://r-forge.r-project.org/).
...
* **Facilidad para publicar en CRAN.** El paquete, una vez maduro, puede subirse a los repositorios de CRAN con solo completar un pequeño formulario (y ser, también, aprobado por los administradores de CRAN, por supuesto).
