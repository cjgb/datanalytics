...
Son paquetes que he marcado como potencialmente relevantes pero que aún no he revisado como debiera. Tal vez alguien tenga algo más que decir sobre ellos. Tiene los comentarios, por supuesto, abiertos.
...
- **[`IPSUR`](https://cran.r-project.org/package=IPSUR)**: Es el paquete que acompaña al libro (libremente disponible) del que el nombre del paquete es acrónimo: [_Introduction to Probability and Statistics Using R_](http://web.archive.org/web/20190127231820/https://cran.r-project.org/web/packages/IPSUR/vignettes/IPSUR.pdf).