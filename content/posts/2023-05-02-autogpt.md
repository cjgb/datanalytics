...
2. Cuando llega un correo nuevo, le pasa el texto a ChatGPT (versión API) con un _prompt_ adecuado.
3. Dependiendo de la respuesta, se toma una determinada acción. Por ejemplo, enviar un aviso vía Telegram.

Por ejemplo, el _prompt_ podría ser algo así como:
...
![](/img/2023/xkcd_tables.png#center)

La larga es que un individuo avieso puede mandarte un correo con un texto más o menos así (adviértase la comilla desemparejada):
