...
Mientras en España no sabemos aún qué pasa con las II Jornadas de Usuarios de R (de hecho, ni siquiera se han corregido las faltas de ortografía de la página de internet de las primeras —sitio ya desaparecido—), las [useR! 2010](http://user2010.org) marchan a todo trapo: en Gaithersburg, Maryland, los días del 20 al 23 de julio no va a faltar ni [rms](http://stallman.org/).

No va a faltar una charla a cuenta de la empresa a la que otras debieran parecerse[^1]. Habrá que tener a mano el enlace  para cuando uno de los habituales cretinos encorbatados nos vuelva a espetar eso de _pero R es una cosa como tan de... universidad..._
