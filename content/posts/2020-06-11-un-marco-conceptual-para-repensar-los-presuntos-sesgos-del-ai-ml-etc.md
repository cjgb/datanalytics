...
He escrito en alguna ocasión sobre el tema: véanse (algunas de) las entradas con etiquetas [sesgo](https://datanalytics.com/tag/sesgo/), [discriminación](https://datanalytics.com/tag/discriminacion/) o [justicia](https://datanalytics.com/tag/justicia/). Recientemente he releído un artículo de Joseph Heath, _[Redefining racism](http://induecourse.ca/redefining-racism/)_ (adivinad por qué) que _mutatis mutandis_, ofrece un marco conceptual muy adecuado para repensar el asunto (pista: todo lo que se refiere al llamado _racismo institucional_).
