...
![](/img/2022/06/kalman_posicion.png#center)
...
```python
obs_sd = 5
observed_pos = true_pos + np.random.normal(0, obs_sd, len(true_pos_pos))
```

![](/img/2022/06/kalman_observado.png#center)
...
![](/img/2022/06/kalman_transicion.png#center)
...
![](/img/2022/06/kalman_kalman.png#center)
