...
En esta entrada voy a comparar los sistemas de coordenadas WGS84, ETRS89, ED50 y el vetustísimo Madrid 1870. Además, lo voy a hacer mal y luego voy a explicar no solo por qué sino por qué no es culpa mía.
...
En resumen, que PROJ decide que el cambio de sistema de referencia entre WGS84 y ETRS89 es la identidad. Lo mismo sucede con ED50. Lo cual no es ni cierto ni satisfactorio pero es la mentira piadosa en la que R + `sf` + PROJ nos hacen vivir.