...
Me acabo de enterar de que nuestros colegas de Sevilla están organizando la primera reunión de su grupo local de usuarios de R. Además, el tema es muy, muy relevante y de interés general: [`R Markdown`](http://rmarkdown.rstudio.com/).
