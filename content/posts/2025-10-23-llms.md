...
- OpenAI ha publicado [_Measuring the performance of our models on real-world tasks_](https://openai.com/index/gdpval/). Hay cierta tendencia a abandonar los antiguos _benchmarks_, evoluciones más o menos sofisticadas del procedimiento tradicional de la evaluación en _train/test_, y reemplazarlos por otros que midan su eficacia en las tareas en las que los usuarios los emplean realmente.
