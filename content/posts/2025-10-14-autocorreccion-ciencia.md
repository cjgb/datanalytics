...
Existe un tipo de bases de datos distribuidas llamadas _eventualmente consistentes_. La promesa que hacen es que si cambias un dato, al cabo de un periodo de tiempo indeterminado, todas sus réplicas convergirán al mismo valor. Mientras tanto, lecturas de nodos distintos pueden dar resultados distintos y contradictorios. Por ejemplo, los _likes_ de una red social pueden estar almacenados en una de tales bases de datos y puede que un usuario en Tokio vea 34 _likes_ a un vídeo y otro en Madrid, 35. Al cabo de un tiempo ambos acabarán viendo 35 (o puede que 37 y 36: nada está garantizado al 100%).
