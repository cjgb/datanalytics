...
* Homogeneidad: el estadístico debería ser similar cuando se comparen _configuraciones_ con una relación funcional distinta para un nivel de ruido análogo (véase la figura adjunta).
