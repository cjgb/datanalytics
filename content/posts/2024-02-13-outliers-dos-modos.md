...
En el primer modo uno debería actuar de manera cuantitativa y aplicar todo el conocimiento sobre la materia que le sea posible concitar. Uno tiene que plantearse por qué aparecen esos aparentes _outliers_, si realmente lo son, si pertenecen a la distribución que se quiere modelar o a otra, contactar con el proveedor de los datos, etc.
