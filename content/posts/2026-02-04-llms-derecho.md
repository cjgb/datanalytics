...
Es decir, someter la totalidad del argumento a una serie de herramientas (sospecho que aún inexistentes) [que hagan una única cosa (pero que la hagan bien)](https://en.wikipedia.org/wiki/Unix_philosophy#Do_One_Thing_and_Do_It_Well) y que operen como el equivalente de los _tests_ en las otras dos disciplinas consideradas en esta entrada. Los LLMs tienden a especular más cuando se enfrentan a tareas abiertas y ambiguas que cuando se les plantea cuestiones específicas y acotadas.
