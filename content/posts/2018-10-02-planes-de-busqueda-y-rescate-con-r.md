...
Ninguno vamos a trabajar nunca en eso, pero [la viñeta del paquete](http://web.archive.org/web/20170718230748/https://cran.r-project.org/web/packages/rSARP/vignettes/rSARP.pdf) está llena de ideas interesantes (así como de innumerables atentados a la ortotipografía, pero esa es otra cuestión).