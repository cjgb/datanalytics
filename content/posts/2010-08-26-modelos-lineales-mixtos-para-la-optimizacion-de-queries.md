...
[![](/wp-uploads/2010/08/grouped_log_data.png)
](/wp-uploads/2010/08/grouped_log_data.png)
...
[![](/wp-uploads/2010/08/residuos.png)
](/wp-uploads/2010/08/residuos.png)
...
* El segundo, que las dependencias del tiempo de ejecución con respecto al tamaño de las _subqueries_ no son, como se suponía un tanto cándidamente, O(1). Más bien, son O(n*m). Y esto sugirió [alterar el orden de los cruces de las tablas](http://www.datanalytics.com/blog/2010/05/19/¿en-que-se-parecen-oracle-y-teradata-a-excel-y-word/) para lograr un plan de ejecución alternativo más rápido y robusto (que, de hecho, se encontró).
