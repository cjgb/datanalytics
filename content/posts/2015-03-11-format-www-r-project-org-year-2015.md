...
Y a los desarrolladores de hoy en día les encantan las páginas que se hacen solas. El contenido de la que anuncio acá se edita en [markdown](http://en.wikipedia.org/wiki/Markdown) y se compila a HTML con [pandoc](http://johnmacfarlane.net/pandoc/) (¿alguien sabe dónde se aloja el código fuente?).
