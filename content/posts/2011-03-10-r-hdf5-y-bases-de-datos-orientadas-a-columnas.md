...
Tras escribir el otro día sobre [RevoscaleR](https://datanalytics.com/2011/03/04/comentarios-sobre-revoscaler/), he tropezado con [un paquete de R, HDF5](http://cran.r-project.org/web/packages/hdf5/index.html) que le permite hacer cosas parecidas usando tecnologías libres. Puede encontrarse más información sobre HDF5 [en la Wikipedia](http://en.wikipedia.org/wiki/Hierarchical_Data_Format) y en la [página del proyecto](https://web.archive.org/web/20160722124305/https://www.hdfgroup.org/HDF5/whatishdf5.html).

![](/img/2011/03/hdf_logo.jpg)
