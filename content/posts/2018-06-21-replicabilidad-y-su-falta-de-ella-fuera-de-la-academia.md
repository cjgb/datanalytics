...
>Aunque en el test/validate nos funciona el modelo con un AUC razonable (0,78) al predecir el churn del mes siguiente funciona fatal (0,57 de AUC). No sé si tienes algún insight que puedas darme
