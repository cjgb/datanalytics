...
![](/img/2020/03/biweight.png#center)
...
Pero esa función es plana a una determinada distancia de cero. Es decir, utilizar esa función es utilizar una función que tiene _mínimos locales_ por doquier (y que son iguales a su máximo absoluto, dicho sea de paso). Que es lo más parecido a dispararse en el pie antes en la línea de salida de la maratón.
