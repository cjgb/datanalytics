...
Se han realizado varios intentos por integrar R y Python. El más antiguo del que tengo noticia (y que creo es ya obsoleto) es [RSPython](https://omegahat.net/RSPython/). El módulo [RPy](https://web.archive.org/web/20191118132821/http://rpy.sourceforge.net/) de Python permite llamar a R desde Python pero echaba de menos una manera de llamar a Python desde R.
