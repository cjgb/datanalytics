...
¿El resumen? Que prácticamente nadie gana dinero usando el llamado [análisis técnico](http://es.wikipedia.org/wiki/An%C3%A1lisis_t%C3%A9cnico). Podría argumentarse incluso que ese 5% corresponde al [sesgo de supervivencia](http://en.wikipedia.org/wiki/Survivorship_bias).
