...
Tengo entendido que el producto tiene algunas restricciones. Por ejemplo, que solo puedes utilizarlo para analizar tus propios datos. Si un señor viene, te pide que le calcules la media de unos números, utilizas SAS Analytics Pro para ello y le cobras, estás violando los términos de uso. ¡Cosas veredes!
