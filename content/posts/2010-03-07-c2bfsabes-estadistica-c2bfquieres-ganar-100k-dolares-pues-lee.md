...
Después del éxito de crítica y público de la [competición de Netflix](https://en.wikipedia.org/wiki/Netflix_Prize), están apareciendo iniciativas similares. De hecho, acabo de recibir [noticia de una más](https://web.archive.org/web/20180807212719/https://www.innocentive.com/ar/challenge/9231572) en la que se busca a una persona o equipo capaz de aportar ideas novedosas para el análisis de un conjunto de datos grande. Y se ofrece, además, una recompensa de 100k dólares para el ganador.
