...
Me consta que en algunos sectores (p.e., seguros) son _todavía_ muy proclives a plantear modelos (p.e., GLM) con muchas variables —las de más todas sus interacciones de todos los niveles—, dejar correr un método paso a paso y volver a las horas por los resultados. ¡Miedo me da!
