...
![](/img/2023/timenet_serie_original.png#center)
...
![](/img/2023/timenet_foto_serie.png#center)
...
![](/img/2023/timenet_inception_block.png#center)

introducida en [este artículo famoso](https://arxiv.org/pdf/1409.4842.pdf) de 2015. Este bloque mapea fotos en fotos (posiblemente, más simples). A partir de la foto transformada, uno puede volver a _estirar_ los píxeles para reconstruir una serie temporal de la misma longitud que la de entrada.
