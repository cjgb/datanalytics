...
Quedándonos en lo viejuno, podría mencionar en el trabajo de Florence Nightingale (al menos, el más famoso de los que se le atribuyen). Por si alguien contraargumentase con el muy problemáticamente inspirador de decisiones ulteriores de Minard (no, no tendrás que tomar decisiones en ese ámbito si no te llamas Adolf y gastas un peculiar tipo de bigote), añadiré que la esencia de la estadística descriptiva no es acumular gráficos y tablas, sino [comparar eficazmente](http://junkcharts.typepad.com/junk_charts/junk-charts-trifecta-checkup-the-definitive-guide.html).
