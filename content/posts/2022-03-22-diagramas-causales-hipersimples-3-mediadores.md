...
Sin embargo, la causalidad (y el gráfico _causal_ que aparece en la entrada) son conceptos metaestadísticos. Al fin y al cabo, el conjunto de datos `(X, Y, Z)` creado no deja de ser una variable normal tridimensional con media cero y matriz de covarianzas
