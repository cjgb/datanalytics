...
Por un lado, he publicado tres capítulos más de mi [libro de estadística](https://libro-estadistica.datanalytics.com/) desde el último anuncio. Son el (brevísimo) de [introducción a la estadística](https://libro-estadistica.datanalytics.com/introducci%C3%B3n-a-la-estad%C3%ADstica.html), y los dedicados a la [estadística descriptiva](https://libro-estadistica.datanalytics.com/estad%C3%ADstica-descriptiva.html) y la estimación puntual.
