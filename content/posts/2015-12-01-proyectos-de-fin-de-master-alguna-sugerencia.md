...
A mí me interesa proponer proyectos que tengan cierta trascendencia. El año pasado invité a un alumno a construir un sistema de predicción de plazas de aparcamiento disponibles en el sistema de bicicletas público de Zaragoza (dado que los datos están disponibles). El paquete [MicroDatosEs](https://cran.r-project.org/web/packages/MicroDatosEs/index.html) mejoró como subproducto de otro proyecto. Etc.
